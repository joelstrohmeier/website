...
Accessibility audits generally focus on the extent to which the container for features (interface) can be used by a broad group of users &mdash; from a standards and compliance perspective. 
...
An audit report is the beginning&hellip; not the end. 
